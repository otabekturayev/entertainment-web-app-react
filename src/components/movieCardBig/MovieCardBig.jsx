...
export const MovieCardBig = ({
  ...
  return (
    <div className="bigCard" style={{ backgroundImage: `url(${img})` }}>
      <div className="play">
      ...
      <div className="bigCardBottom">
        <div className="bigCardMovieInfo">
          ...
          <div className="movieOrSerie">{category}</div>
          <div className="circle"></div>
          <div className="rating">{rating}</div>
        </div>
        <div className="bigCardMovieName">{name}</div>
      </div>
    </div>
  );
};
